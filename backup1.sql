...
-- Started on 2020-02-12 10:54:17
...
--
-- TOC entry 2823 (class 1262 OID 16394)
...
-- Dependencies: 203
-- Data for Name: oppilas; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.oppilas (id, nimi, ika) FROM stdin;
1	Niina	30
2	Nana	29
3	Jenni	30
4	Sanna	30
...
-- Dependencies: 202
-- Name: oppilas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.oppilas_id_seq', 14, true);
...
-- Completed on 2020-02-12 10:54:17
